...
def build_model(input_shape, trainY):
...
def plot_predictions_with_dates(type,twitter,dates,y_actual_lstm,y_pred_lstm):
    ...
    for i,predicted_feature in enumerate(predicted_features):
        ...
        image_name = f'./static/graphs/graph_{type}_{predicted_feature}.png'
...
def generateGraph():
    ...
    cnn_lstm_model_without_twitter = build_model((X_train_lstm_without_twitter.shape[1],X_train_lstm_without_twitter.shape[2]), trainY)
    cnn_lstm_model_twitter = build_model((X_train_lstm_twitter.shape[1],X_train_lstm_twitter.shape[2]), trainY)
    ...
    name = 'arima_training_open_wo_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
    ...
    name = 'arima_training_open_w_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
    ...
    name = 'arima_testing_open_wo_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
    ...
    name = 'arima_testing_open_w_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
    ...
    name = 'arima_training_close_wo_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
    ...
    name = 'arima_training_close_w_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
    ...
    name = 'arima_testing_close_wo_twitter.png'
    plt.savefig(BASE_URL.format(name), dpi=fig.get_dpi())
